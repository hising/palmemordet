    ...
    return (
      <div id="newsletter-signup">
        <form action="//ridgestreet.us5.list-manage.com/subscribe/post?u=4e670822a8a8ed8b7329c8bc0&amp;id=43398d6dd0"
              ...
              target="_blank" formNoValidate={true} onSubmit={this.handleSubmit}>
          ...
          <div className="input-group">
            ...
            <span className="input-group-btn">
                    <button className="btn btn-success" type="submit" value="Subscribe" name="subscribe"
                            id="mc-embedded-subscribe" disabled={!this.state.valid}>Prenumerera</button>
                  </span>
          </div>
        </form>
      </div>
